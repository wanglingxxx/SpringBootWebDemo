				...
				var atr=tbody2.getElementsByTagName('tr');
				var pages=Math.ceil(atr.length/12);
				
				var paging2=document.getElementById('paging2');
				...
				for(var i=1;i<=pages;i++){
					...
					if(pages>6){
						...
						for(var i=1;i<=5;i++){
							...
							paging2.appendChild(nodeA);

						}

						var a=paging2.getElementsByTagName('a');
					...
					for(var j=0;j<a.length;j++){
						...
						a[j].onclick=function(){
							...
							if(num>=5&&num<=pages-5){
								...
								paging2.appendChild(nodeAFirst);
