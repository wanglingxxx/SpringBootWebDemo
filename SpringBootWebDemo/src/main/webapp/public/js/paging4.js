				...
				var atr=tbody4.getElementsByTagName('tr');
				var pages=Math.ceil(atr.length/12);
				
				var paging4=document.getElementById('paging4');
				...
				for(var i=1;i<=pages;i++){
					...
					if(pages>6){
						...
						for(var i=1;i<=5;i++){
							...
							paging4.appendChild(nodeA);

						}

						var a=paging4.getElementsByTagName('a');
					...
					for(var j=0;j<a.length;j++){
						...
						a[j].onclick=function(){
							...
							if(num>=5&&num<=pages-5){
								...
								paging4.appendChild(nodeAFirst);
