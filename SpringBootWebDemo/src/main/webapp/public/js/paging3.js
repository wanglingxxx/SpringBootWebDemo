				...
				var atr=tbody3.getElementsByTagName('tr');
				var pages=Math.ceil(atr.length/12);
				
				var paging3=document.getElementById('paging3');
				...
				for(var i=1;i<=pages;i++){
					...
					if(pages>6){
						...
						for(var i=1;i<=5;i++){
							...
							paging3.appendChild(nodeA);

						}

						var a=paging3.getElementsByTagName('a');
					...
					for(var j=0;j<a.length;j++){
						...
						a[j].onclick=function(){
							...
							if(num>=5&&num<=pages-5){
								...
								paging3.appendChild(nodeAFirst);
